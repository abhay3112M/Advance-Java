...
public class ATM {
	...
	public static void main(String []args) {
		...
		ATM helper = new ATM(new Bank(bankName));
		while(true) {
			helper.start();
		}
	}
	...
	private void openAccount() {
		// TODO Auto-generated method stub
		int accountType=keyboard.readInt("1. Saving Account \n2. Current Account \n3. OverDraft Account");
		...
		if(accountType!=1 && accountType!=2 && accountType!=3) {
			showInfo("Select a Valid Account Type");
			return;
		}
		int accountNumber = bank.openAccount(name, password, amount,accountType);

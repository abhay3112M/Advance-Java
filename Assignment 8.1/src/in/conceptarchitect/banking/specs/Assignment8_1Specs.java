...
import in.conceptarchitect.utils.Helper;
...
public class Assignment8_1Specs {
	...
	public void searchCanReturnAllCurrentAccounts() {
		...
		selectedAccounts= helper.currentAccounts(accounts);//search for current accounts
	...
	public void searchCanReturnAccountWithNegativeBalance() {
		selectedAccounts=helper.negativeBalanceAccounts(accounts); //search for accounts with negative balance
	...
	public void searchCanReturnAllAccountWithLastNameMishra() {
		selectedAccounts=helper.mishraAccounts(accounts, "Mishra");
